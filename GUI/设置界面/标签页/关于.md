...
```json
{
  "libraries": [
    ...
    {
      "uniqueId": "co.touchlab:stately-concurrency-jvm",
      "funding": [],
      "developers": [
        {
          "name": "Kevin Galligan"
      ...
      "scm": {
        "connection": "scm:git:git://github.com/touchlab/Stately.git",
        "url": "https://github.com/touchlab/Stately",
        "developerConnection": "scm:git:git://github.com/touchlab/Stately.git"
      },
      "name": "Stately",
      "website": "https://github.com/touchlab/Stately",
      "licenses": [
        "Apache-2.0"
      ]
    },
    {
      "uniqueId": "co.touchlab:stately-concurrent-collections-jvm",
      "funding": [],
      "developers": [
        {
          "name": "Kevin Galligan"
    ...
    {
      "uniqueId": "co.touchlab:stately-strict-jvm",
      "funding": [],
      "developers": [
        {
          "name": "Kevin Galligan"
    ...
    {
      "uniqueId": "io.insert-koin:koin-compose-jvm",
      "funding": [],
      "developers": [
        {
      ...
      "scm": {
        "connection": "scm:git:https://github.com/InsertKoinIO/koin.git",
    ...
    {
      "uniqueId": "io.insert-koin:koin-core-jvm",
      "funding": [],
      "developers": [
        {
          "name": "Arnaud Giuliani"
    ...
    {
      "uniqueId": "io.insert-koin:koin-logger-slf4j",
      "funding": [],
      "developers": [
        {
          "name": "Arnaud Giuliani"
    ...
    {
      "uniqueId": "org.jetbrains.compose.runtime:runtime-desktop",
      "funding": [],
      "developers": [
        {
