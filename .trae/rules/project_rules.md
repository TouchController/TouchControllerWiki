...
wiki 旨在全面地、系统地介绍 [TouchController](https://github.com/TouchController/TouchController) 模组的一切，用来帮助玩家了解 TouchController 的玩法、特性等等。
...
注：链接前后的空格根据链接显示文本而定，例如中文链接不用添加，而英文链接前后需要添加。
